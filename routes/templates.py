...
from models import db, BatchTemplate, JobTemplate, SavedPrompt, SavedMarkingScheme
...
def _template_matches_filter(template, template_type, category_filter, search_query):
    ...
    if search_query:
        ...
        desc_match = (hasattr(template.description, 'lower') and 
                     template.description and 
                     search_lower in template.description.lower())

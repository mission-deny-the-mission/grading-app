...
class TestBatchTemplates:
    ...
    def test_batch_templates_crud(self, client):
        """Test create, list, and get operations for batch templates."""
        # Create
        resp = client.post(
            "/api/batch-templates",
            json={
...
class TestSavedConfigsDetailUpdate:
    """Test saved configuration detail and update operations."""

    def test_saved_prompt_get_and_update(self, client):
        """Test get and update operations for saved prompts."""
        # Create prompt first
        resp = client.post(
            "/api/saved-prompts",
            json={
    ...
    def test_saved_marking_scheme_get_and_update(self, client):
        """Test get and update operations for saved marking schemes."""
...
class TestBatchOps:
    """Test batch operations like duplicate and archive."""

    def test_duplicate_and_archive_batch(self, client, app):
        """Test batch duplication and archiving operations."""
    ...
    def test_batch_jobs_and_export(self, client, app, tmp_path):
        """Test batch job listing and export functionality."""
        with app.app_context():
    ...
    def test_available_jobs_endpoint(self, client, app):
        """Test available jobs endpoint for batch assignment."""
        with app.app_context():

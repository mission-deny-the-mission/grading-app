...
class TestPasswordResetRequest:
    ...
    def test_request_password_reset_for_existing_user(self, client, app, test_user, multi_user_mode):
    ...
    def test_request_password_reset_for_nonexistent_user(self, client, app, multi_user_mode):
    ...
    def test_request_password_reset_in_single_user_mode_fails(self, client, app, test_user):
...
class TestPasswordResetCompletion:
    ...
    def test_reset_password_with_valid_token(self, client, app, test_user, multi_user_mode):
    ...
    def test_login_works_after_password_reset(self, client, app, test_user, multi_user_mode):
    ...
    def test_reset_password_with_weak_password(self, client, app, test_user, multi_user_mode):
    ...
    def test_reset_password_without_password_fails(self, client, app, test_user, multi_user_mode):
    ...
    def test_reset_password_in_single_user_mode_fails(self, client, app, test_user):
        ...
        response = client.post(
            "/api/auth/password-reset/some-token",
            json={"password": "NewPassword456!"}
        )
...
class TestGetCurrentUser:
    ...
    def test_get_current_user_when_logged_in(self, client, app, test_user, multi_user_mode):
    ...
    def test_get_current_user_when_not_logged_in(self, client, app, multi_user_mode):
        ...
        response = client.get("/api/auth/user")
        assert response.status_code in [302, 401]  # 302 redirect or 401 unauthorized both valid
...
class TestRegistration:
    ...
    def test_register_with_duplicate_email_fails(self, client, app, test_user, multi_user_mode):

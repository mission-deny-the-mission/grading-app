"""
Additional tests for routes.main to cover configuration endpoints.
Also covers error paths for API key and external service tests.
"""
...
class TestConfigEndpoints:
    ...
    def test_save_config_writes_env_and_session(self, client):
        """Test saving configuration writes to environment and session."""
        payload = {
